...
import chair3 from '@/assets/hero-chair-3.png';
import chair2 from '@/assets/hero-chair2.png';
...
export default function Hero() {
  return (
    <section className='grid md:grid-cols-2 lg:min-h-[80svh] lg:place-content-center lg:py-10 gap-x-16 overflow-y-clip py-5 relative page-size gap-y-8'>
      <div className='flex flex-col h-full lg:py-16 items-center text-center xl:text-5xl md:text-start md:pb-20 pb-10 w-full'>
        <h1 className=' text-[1.75rem] lg:text-4xl font-bold capitalize  leading-8 md:text-left md:leading-loose lg:text-balance'>
          discover the latest{' '}
...
const heroImages = [chair, chair2, chair3];
